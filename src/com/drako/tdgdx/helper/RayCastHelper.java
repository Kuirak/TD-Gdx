...
public class RayCastHelper {
	...
	public static boolean IntersectLineCircle(Vector2 circleCenter,
			float radius, RayInfo ri) {

		Vector2 vOrginNew = new Vector2(circleCenter);
		// vOrginNew.sub(ri.start);

		float b = vOrginNew.x * ri.rayDir.x + vOrginNew.y * ri.rayDir.y;
		float c = radius * radius - (vOrginNew.len2());
